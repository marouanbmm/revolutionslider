...
[Twig](http://twig.webmarketsolution.net) template engine for Magento2.
...
`Twig_LoaderInterface`. [http://twig.webmarketsolution.net/doc/api.html#loaders](http://twig.webmarketsolution.net/doc/api.html#loaders)

Event `twig_init` with event object `twig`. You can add here more functions, filters, tags, etc.
[http://twig.webmarketsolution.net/doc/advanced.html](http://twig.webmarketsolution.net/doc/advanced.html)
...
[Ben Mansour Marouan](https://developer.webmarketsolution.com)
